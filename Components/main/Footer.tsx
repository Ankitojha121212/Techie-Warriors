...
const Footer = () => {
    return (
        <div className="w-full h-full bg-slate-900 text-white shadow-lg px-5 pt-5 ">
            <div className="w-full flex flex-col items-center justify-center m-auto">
                <div className="w-full h-full flex flex-row items-center justify-around flex-wrap">
                    ...
                    <div className="min-w-[200px] h-auto flex flex-col items-center justify-start">
                        ...
                        <p className="flex flex-row items-center mt-[15px] cursor-pointer">
                            ...
                            <span className="text-[15px] ml-[6px]">Patna, Bihar</span>
                        </p>
                        <p>India</p>
                        <div>
                            <div className="card">
                    ...
                    <div className="min-w-[200px] h-auto flex flex-col items-center justify-center">
                        ...
                        <p className="flex flex-row items-center my-[5px] cursor-pointer">
                            ...
                            <span className="text-[15px] ml-[6px]">Our Team</span>
                        </p>
                    </div>
                    <div className="min-w-[200px] h-auto flex flex-col items-center justify-start">
                        <div className="font-bold text-[16px]">Others</div>
                        <p className="flex flex-row items-center my-[5px] cursor-pointer">

                            <span className="text-[15px] ml-[6px]">FAQ's</span>
                        </p>
                        <p className="flex flex-row items-center my-[5px] cursor-pointer">
                ...
                <div className=" mt-8 text-center font-medium text-sm rounded-md px-4 p-1">
                    &copy; Techie Warriors 2023 Inc. All rights reserved
                </div>
            </div>
        </div>
    )

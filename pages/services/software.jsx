      ...
      <div className="p-5">
        <section className="mb-8">
          <p className="font-semibold text-2xl mb-4">
            We specialize in creating stunning and user-friendly <text className="text-red-700">Android</text>  and <text className="text-red-700">IOS</text> Software
        ...
        <section className="mb-8 text-xl font-semibold">
          <h2 className="text-4xl p-1 rounded-md text-center font-semibold mb-4">
            <text className="bg-red-600 px-5 p-1 text-white rounded-md">
              Services Offered in Software Development
            </text>
          </h2>
